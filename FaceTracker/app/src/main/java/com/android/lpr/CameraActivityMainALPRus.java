...
import com.android.lpr.env.BorderedText;
import com.android.lpr.env.ImageUtils;
import com.android.lpr.env.Logger;
import com.android.lpr.tracking.MultiBoxTracker;

import com.android.lpr.R;

public class CameraActivityMainALPRus extends Activity
    implements OnImageAvailableListener, Camera.PreviewCallback {

  private static final float MINIMUM_CONFIDENCE = 0.6f;//change it in openalpr.defaults.conf
  static final String RUNTIME_DATA_DIR_ASSET = "runtime_data";
  static final String ANDROID_DATA_DIR = "/data/data/com.android.lpr";
  ...
  protected void setFragment() {
    ...
    mBtnSwitch.setOnClickListener(new View.OnClickListener() {
      ...
      public void onClick(View v) {
        Intent myIntent = new Intent(CameraActivityMainALPRus.this, CameraActivityMainALPReu.class);
